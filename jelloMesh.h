...
public:
    ...
    virtual void Update(double dt, 
        const World& world,
        const vec3& externalForces = vec3(0, -9.8, 9.8));
...
protected:
    ...
    public:
        ...
        int m_p; //particle's index
        vec3 m_normal; //normal of the surface
        double m_distance; //how far it penetrated
        IntersectionType m_type; //contact vs collision
    };
};
